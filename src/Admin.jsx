    ...
    <div style={{ minHeight: "100vh", background: "#1A1A1A", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      <div style={{ width: "100%", maxWidth: 340 }}>
        ...
        <div style={{ background: "#2A2A2A", borderRadius: 12, padding: 22, border: "1px solid #333" }}>
          ...
          <div style={{ marginTop: 14, padding: "9px 11px", background: "#333", borderRadius: 6, border: "1px solid #444" }}>
            <div style={{ fontSize: 11, color: "#6A6A6A" }}>Телефон: <span style={{ color: "#CCC" }}>+998000000000</span></div>
            <div style={{ fontSize: 11, color: "#6A6A6A", marginTop: 2 }}>Пароль: <span style={{ color: "#CCC" }}>password</span></div>
          </div>
        </div>
      </div>
    </div>
